    ...
    return (
        <div className="space-y-6 max-w-5xl">
            ...
            <div className="rounded-lg border border-amber-500/40 bg-amber-500/10 p-4 space-y-2">
                <p className="text-sm font-bold text-amber-300">⚠️ シークレットリプライ機能のご利用にあたって</p>
                <ul className="text-xs text-amber-200/90 space-y-1 list-disc list-inside leading-relaxed">
                    <li>
                        <span className="font-semibold">シークレットリプライ機能はシャドウバンのリスクがあるため、使用は自己責任でお願いします。</span>
                        短時間に大量のメンション送信はスパム判定・凍結の原因になり得ます（遅延・件数の調整を推奨）。
                    </li>
                    <li>
                        <span className="font-semibold">できるだけ「✉️ シークレット（DM送信）」のご利用を推奨します。</span>
                        メンションより通知が自然で、相手にも届きやすいためです。
                    </li>
                    <li>
                        ただし <span className="font-semibold">DMには送信数の制限（レートリミット）があり、相手がDMを受信可能に設定している必要があります。</span>
